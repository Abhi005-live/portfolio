...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Fresher — Open to Opportunities",
    description: [
      "Built full-stack web applications using React, Next.js, and Node.js.",
      "Developed AI/ML projects including personality prediction from CV analysis.",
      "Created and deployed club websites and web tools used by peers.",
      "Participated in hackathons including Nirman 5.0 HackNation.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NEXTJS,
